        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          animationDelay: "0.2s"
            ...
            <div className="relative">
              ...
              <div className="relative w-64 h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden border-4 border-primary/30 glow-primary">
                <img src={profilePhoto} alt="MD. Tanzil Ahamed" className="w-full h-full object-cover object-top" />
              </div>
              {/* Floating Badge */}
              <div className="absolute -bottom-4 -right-4 bg-card border border-border rounded-xl px-4 py-2 shadow-elevated">
                <span className="text-primary font-semibold">4+ Years</span>
                <span className="text-muted-foreground text-sm block">Experience</span>
              </div>
            </div>
          </div>
